...
const rows = [
  ...
  { id: 'sobrenome', numeric: false, disablePadding: false, label: 'Sobrenome' },
  { id: 'email', numeric: false, disablePadding: false, label: 'E-mail' },
  { id: 'datanasc', numeric: false, disablePadding: false, label: 'Data De Nascimento' },
  { id: 'access', numeric: false, disablePadding: false, label: 'Acesso Especial' },
];
  ...
  constructor(props) {
      ...
      fetch("http://localhost:8080/library/management/manager/manage-access", {
        ...
        res.forEach(element => {
            ...
            this.state.data.push(createData(element.id,element.nome,element.sobrenome,element.email,element.dataNasc, auth));
    ...
    return (
      <Paper className={classes.root}  style = {{height: "60%"}}>
        ...
        <div id="action-buttons" style={{height: "40px"}}>
          <Button id= "act-btn">Autorizar Acesso Especial</Button>
          <Button id= "act-btn">Desautorizar Acesso Especial</Button>
        </div>
      </Paper>
    );
  }
